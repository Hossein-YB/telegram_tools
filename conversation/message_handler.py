...
class CustomMessageHandler(MessageHandler):
    ...
    async def check_if_has_matching_listener(self, client: "CustomClient", message: Message):
    ...
    async def check(self, client: "CustomClient", message: Message):
        listener_does_match = (
    ...
    async def resolve_future_or_callback(self, client: "CustomClient", message: Message, *args):
